...
[64 atomic model obligations](atomic-claims.json) documenting theorem links,
...
source hashes and coverage freshness, and requires 200 deliberately invalid
...
418 explicit equality and order proof declarations across 25 modules. This count
